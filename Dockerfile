...
RUN rm helm.tgz
# k6
RUN if [ "$TARGETPLATFORM" = "linux/amd64" ]; then wget https://github.com/grafana/k6/releases/download/v0.37.0/k6-v0.37.0-linux-amd64.tar.gz -O k6.tgz && tar -zxvf k6.tgz && mv k6-v0.37.0-linux-amd64/k6 /usr/bin ; else wget https://github.com/grafana/k6/releases/download/v0.37.0/k6-v0.37.0-linux-arm64.tar.gz -O k6.tgz && tar -zxvf k6.tgz && mv k6-v0.37.0-linux-arm64/k6 /usr/bin ; fi
